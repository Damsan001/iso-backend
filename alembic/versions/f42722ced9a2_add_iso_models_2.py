...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "is_hierarchical", sa.Boolean(), server_default="false", nullable=False
        ),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["empresa_id"], [f"{SCHEMA}.empresa.empresa_id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("area_id"),
        schema=SCHEMA,
    )
    op.create_index(
        "uq_areas_empresa_nombre",
        "areas",
    ...
    op.create_table(
        ...
        sa.Column("deleted_at", sa.DateTime(timezone=True), nullable=True),
        sa.ForeignKeyConstraint(
            ["catalog_id"], [f"{SCHEMA}.catalog.catalog_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["empresa_id"],
            [f"{SCHEMA}.empresa.empresa_id"],
        ),
        sa.ForeignKeyConstraint(
            ["parent_item_id"],
            [f"{SCHEMA}.catalog_item.item_id"],
        ),
    ...
    op.create_index(
        "uq_permiso_scope",
        "permiso",
        ["empresa_id", sa.literal_column("upper(codigo)")],
        unique=True,
        schema=SCHEMA,
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["permiso_id"], [f"{SCHEMA}.permiso.permiso_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["rol_id"], [f"{SCHEMA}.rol.rol_id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column("deleted_at", sa.DateTime(timezone=True), nullable=True),
        sa.ForeignKeyConstraint(
            ["area_id"], [f"{SCHEMA}.areas.area_id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["empresa_id"], [f"{SCHEMA}.empresa.empresa_id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["clasificacion_item_id"],
            [f"{SCHEMA}.catalog_item.item_id"],
        ),
        sa.ForeignKeyConstraint(
            ["custodio_id"],
            [f"{SCHEMA}.usuario.usuario_id"],
        ),
        sa.ForeignKeyConstraint(
            ["empresa_id"],
            [f"{SCHEMA}.empresa.empresa_id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "visible_empresa", sa.Boolean(), server_default="true", nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["usuario_id"], [f"{SCHEMA}.usuario.usuario_id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["documento_id"], [f"{SCHEMA}.documento.documento_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["empresa_id"],
            [f"{SCHEMA}.empresa.empresa_id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["version_id"],
            [f"{SCHEMA}.documento_version.version_id"],
            ondelete="CASCADE",
        ),
