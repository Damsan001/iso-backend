...
class Activo(Base):
    ...
    area_item_id = Column(BigInteger, ForeignKey("iso.catalog_item.item_id"), nullable=True)  # NUEVO
    ...
    area = relationship("CatalogItem", foreign_keys=[area_item_id], lazy="joined")  # NUEVA
