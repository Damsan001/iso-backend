...
from pydantic import BaseModel, EmailStr, Field, field_validator, ConfigDict, StringConstraints
...
class CreateUserRequest(BaseModel):
    ...
    def strong_password(cls, v: str) -> str:
        ...
        if not (has_upper and has_lower and has_digit and has_symbol):
            raise ValueError("La contraseña debe incluir mayúsculas, minúsculas, números y símbolos.")
        return v
